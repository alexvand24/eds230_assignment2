...
#read in the almond_yield_anomaly R script in order to use the almond_yield_anomaly() function in this RMD 
source(here("almond_yield_anomaly.R"))
```
...
# Test the `almond_yield_anomaly()` function 
