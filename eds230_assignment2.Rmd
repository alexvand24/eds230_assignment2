...
We built a simpler replica of the almond yield model built by Lobell et al. (2006) using two different functions. From 1988 to 2010, the average almond yield was `r avg_yield` tons/acre per year. During this time period, average almond yield peaked at `r max_yield` in 1994 while some years reported average almond yields of zero. 
...
## Function to extract minimum temperature from any month in the climate data 
```{r}
